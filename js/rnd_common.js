...
$(document).on("change", "#sample_season_id", function(event)
{
    ...
    $.ajax({
        ...
        success: function (data, status)
        {
            ...
            {
                rnd_code_view += "<tr><td><input type='hidden' name='elm_id[]' id='elm_id' value='"+data[i]['id']+"'  /> \n\
                    <input type='checkbox' id='rnd_code[]' name='rnd_code"+data[i]['id']+"' value='"+data[i]['id']+"' class='checksingle' checked='' /> "+data[i]['rnd_code']+"</td><td> \n\
                    <input type='text' name='specific_sowing_date[]' id='specific_sowing_date"+i+"' class='form-control specific_sowing_date' /></td><td> \n\
                    <input type='text' name='specific_transplanting_date[]' id='specific_transplanting_date"+i+"' class='form-control specific_transplanting_date' /></td></tr>";
            }
