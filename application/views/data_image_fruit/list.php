...
<div class="col-sm-12" style="overflow-x: auto">
    <table class="table table-hover table-bordered">
        ...
        <tr>
            ...
            <th>
                <img style="max-width: 250px;" src="<?php echo base_url().$dir['fruit_image_config'].'/'.$sample_image; ?>">
            ...
            foreach($varieties as $key=>$variety)
            {
                ...
                <tr>
                    ...
                    <td style="min-width: 300px;">
                        ...
                        ?>
                        <img id="image_normal_<?php echo $variety['id'];?>" style="max-width: 250px;" src="<?php echo base_url().$dir['fruit_image_data'].'/'.$image; ?>">
                        ...
                        if($variety['replica_status']==1)
                        {
                            ...
                            ?>
                            <br><br><img id="image_replica_<?php echo $variety['id'];?>" style="max-width: 250px;" src="<?php echo base_url().$dir['fruit_image_data'].'/'.$image; ?>">
