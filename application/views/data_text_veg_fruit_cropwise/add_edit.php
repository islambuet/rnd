...
?>
<form class="form_valid" id="save_form" action="<?php echo base_url();?>data_text_veg_fruit_cropwise/index/save" method="post">
    ...
    <div class="row widget" id="veg_fruit_text">
...
//        $(".form_valid").validationEngine();
        ...
        $(document).on("change", "#crop_type_id", function(event)
        {
            ...
            {
                $.ajax({
                    url: base_url+"data_text_veg_fruit_cropwise/get_varieties_for_data_text",
                    type: 'POST',
                    dataType: "JSON",
        ...
        $(document).on("change", "#variety_id", function(event)
        {
            ...
            {
                $.ajax({
                    url: base_url+"data_text_veg_fruit_cropwise/index/list",
                    type: 'POST',
                    dataType: "JSON",
