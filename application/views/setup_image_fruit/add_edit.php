...
?>
<form class="form_valid" id="save_form" action="<?php echo base_url();?>setup_image_fruit/index/save" method="post">
    ...
    <div class="row widget" id="config_fruit_images">
...
//        $(".form_valid").validationEngine();
        ...
        $(document).on("change", "#crop_type_id", function(event)
        {
            ...
            {
                $.ajax({
                    url: base_url+"setup_image_fruit/index/list",
                    type: 'POST',
                    dataType: "JSON",
