    ...
    <div class="col-xs-12" style="overflow-x: auto;">
        <table class="table table-hover table-bordered">
            ...
            <tr>
                ...
                <th><?php echo $this->lang->line("LABEL_COMPANY_CODE"); ?></th>
            ...
            if(sizeof($principalInfo)>0)
            {
                ...
                ?>
                    <tr>
                        ...
                        <td><?php echo $principal['company_name'];?></td>
                        <td><?php echo $principal['company_code'];?></td>
                        <td><?php echo $principal['contact_person_name'];?></td>
                        <td><?php echo $principal['contact_number'];?></td>
                        <td>
                            <a href="<?php echo base_url();?>setup_competitor/index/edit/<?php echo $principal['id'];?>">
