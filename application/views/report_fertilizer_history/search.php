...
?>
<form class="form_valid" id="save_form" action="<?php echo base_url()?>report_fertilizer_history/index/report" method="post">
    <div class="row widget">
        ...
        <div class="row show-grid">
            <div class="col-xs-4">
                <label class="control-label pull-right"><?php echo $this->lang->line('LABEL_SELECT_FERTILIZER');?></label>
            </div>
            <div class="col-sm-5">
