...
foreach($varieties as $variety)
{
    ...
    if($options['max_estimated_yield_per_ha']==1)
    {
        ...
        if($has_fruit)
        {
            ...
            {
                $data['max_estimated_yield_per_ha']['normal']=round($avg_wt_normal*$variety['plants_per_hectare']*$total_fruit_normal*$total_harvest/$total_harvested_plants_normal/1000000,2);
            }
            if(($total_harvested_plants_replica>0)&&($total_fruit_replica>0))
            {
                $data['max_estimated_yield_per_ha']['replica']=round($avg_wt_replica*$variety['plants_per_hectare']*$total_fruit_replica*$total_harvest/$total_harvested_plants_replica/1000000,2);
            }

        }
        else
        {
            $data['max_estimated_yield_per_ha']['normal']=round($avg_wt_normal*$variety['plants_per_hectare']/1000000,2);
            $data['max_estimated_yield_per_ha']['replica']=round($avg_wt_replica*$variety['plants_per_hectare']/1000000,2);
        }
    }
