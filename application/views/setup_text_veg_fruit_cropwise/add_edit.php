<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    $data["link_back"]=base_url()."setup_text_veg_fruit_cropwise";
...
?>
<form id="save_form" action="<?php echo base_url();?>setup_text_veg_fruit_cropwise/index/save" method="post">
    ...
    <div class="row widget">
        ...
        foreach($columns as $key=>$column)
        {
            ...
            <div class="row show-grid">
                <div class="col-xs-4">
                    <label class="control-label pull-right"><?php echo $this->lang->line(strtoupper($key));?></label>
                </div>
                <div class="col-xs-1">
