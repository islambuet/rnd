...
?>
<form class="form_valid" id="save_form" action="<?php echo base_url();?>setup_image_harvest_cropwise/index/save" method="post">
    ...
    <div class="row widget" id="config_harvest_cropwise_images">
...
//        $(".form_valid").validationEngine();
        ...
        {
            $("#config_harvest_cropwise_images").html("");
            $("#season_id").val("");
        ...
        $(document).on("change", "#crop_type_id", function(event)
        {
            ...
            {
                $.ajax({
                    url: base_url+"setup_image_harvest_cropwise/index/list",
                    type: 'POST',
                    dataType: "JSON",
