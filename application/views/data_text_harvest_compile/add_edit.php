...
?>
<form class="form_valid" id="save_form" action="<?php echo base_url();?>data_text_harvest_compile/index/save" method="post">
...
//        $(".form_valid").validationEngine();
        ...
        $(document).on("change", "#variety_id", function(event)
        {
            ...
            {
                $.ajax({
                    url: base_url+"data_text_harvest_compile/index/list",
                    type: 'POST',
                    dataType: "JSON",
